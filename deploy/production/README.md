...
- Не заводит тенанта продавца: регистрации и подключения канала из консоли ещё нет (OQ-213). Публичное демо [Р-160]
  работает сразу, продавец входит туда, где у него уже есть членство.
