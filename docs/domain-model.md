...
Статус: **v0.14** · 2026-09-15 · шаг 15. Поля и ограничения окончательно определены DDL в [migrations/](../migrations/); при расхождении с текстом источник истины — миграции.
...
| Pricing | PricingStrategy, GuardRail, PriceIntent, PriceDecision, PriceHistory, CompetitorSnapshot |
