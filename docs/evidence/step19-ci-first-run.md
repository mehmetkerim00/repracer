...
## Второй прогон — на `main` после итога ревью

Прогон [35112868772](https://github.com/mehmetkerim00/repracer/actions/runs/35112868772), коммит `4679820`. Итог тот же: полнота
сборки, миграции и смоук, мутационная проверка (148 мутаций, 0 непойманных честным раннером, контроль — 176 проверок), typecheck —
зелёные; тесты — **270 из 272**, красные те же два теста порядка за брокером.
