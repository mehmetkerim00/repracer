-- 0035_verify_schema_invariants_v6.sql
-- Проверка схемы после шага 9 (последняя проверка набора): правила 0033 + валюты EUR/USD, налоговые режимы витрин, проекции пути решения, объяснимость решения.
