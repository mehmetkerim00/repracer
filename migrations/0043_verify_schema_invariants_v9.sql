-- 0043_verify_schema_invariants_v9.sql
-- Проверка схемы после шага 12 (последняя проверка набора): правила 0041 + слепок объяснения решения [Р-68],
-- остановки человеком и системные остановки [Р-69, Р-70], валюта сумм [Р-71], опасные изменения [Р-73], роль оператора.
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conrelid = 'channel_data.price_decision'::regclass AND conname = 'price_decision_explanation_present')
