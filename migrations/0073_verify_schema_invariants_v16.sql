-- 0073_verify_schema_invariants_v16.sql
-- Проверка схемы после шага 19 — последняя в наборе (0071 остаётся историей). Р-93: правило проверяет ПОВЕДЕНИЕ либо не существует. Р-94: правило,
