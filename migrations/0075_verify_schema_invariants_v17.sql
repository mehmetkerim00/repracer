-- 0075_verify_schema_invariants_v17.sql
-- Проверка схемы после шага 20 — последняя в наборе (0073 остаётся историей); правила не менялись, миграция 0074 добавила
