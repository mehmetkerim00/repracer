-- 0076_verify_schema_invariants_v17.sql
-- Проверка схемы после шага 20 — последняя в наборе (0073 остаётся историей); правила не менялись, миграции 0074–0075 добавили
