-- 0079_verify_schema_invariants_v18.sql
-- Проверка схемы после шага 21 — последняя в наборе (0076 остаётся историей); правила не менялись. Шаг 21: 0077 даёт имена ограничениям Р-111, 0078 — страж массовой правки границ [Р-88, OQ-144].
