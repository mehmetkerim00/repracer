-- 0084_verify_schema_invariants_v20.sql
-- Проверка схемы после шага 23 — последняя в наборе (0081 остаётся историей); правила не менялись. Шаг 23: 0082 — остановка по
