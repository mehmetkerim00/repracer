-- 0089_verify_schema_invariants_v21.sql
-- Проверка схемы после шага 24 — последняя в наборе (0084 остаётся историей). Одно изменение правил: в список функций SECURITY DEFINER,
