-- 0081_verify_schema_invariants_v19.sql
-- Проверка схемы после шага 22 — последняя в наборе (0079 остаётся историей); правила не менялись. Шаг 22: 0080 — остановка витрины
-- по неверной базе цены [Р-116], реестры параметров Р-115 и Р-116, изменчивость функции 0078 (ревью шага 21); поведение — смоук-тесты
-- и мутационная проверка [Р-108].
