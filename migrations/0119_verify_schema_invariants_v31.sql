-- 0119_verify_schema_invariants_v31.sql
-- Проверка схемы после шага 35 — последняя в наборе (0109, 0112, 0114 и 0116 остаются историей).
-- Шаг 35 [Р-154] правил не добавил: индексы 0117 — под запросы, а 0118 — путь остатков; проверка перенесена, чтобы идти последней.
