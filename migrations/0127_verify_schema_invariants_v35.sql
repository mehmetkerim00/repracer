-- 0127_verify_schema_invariants_v35.sql
-- Проверка схемы после шага 40 — последняя в наборе (0109, 0112, 0114, 0116, 0119, 0121, 0123 и 0125 остаются историей).
...
-- Проверка перенесена под новый номер, чтобы идти последней.
