import type {
  ...
  SNAPSHOT_INCONSISTENCIES, STOP_SCOPES, STOP_STAGES, STRATEGY_PARAM_NAMES, STRATEGY_TYPES, UNMET_REQUIREMENTS, WRITE_ERROR_CODES, LOWEST_SCOPES, MARGIN_REQUIREMENTS,
...
export type ValueKey =
  ...
  | (typeof LOWEST_SCOPES)[number] | (typeof MARGIN_REQUIREMENTS)[number]
