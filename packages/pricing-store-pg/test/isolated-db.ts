 ...
 */
export type TestRole = 'svc_app' | 'svc_fx_loader' | 'svc_dispatcher' | 'svc_exporter' | 'svc_admin' | 'svc_provisioning' | 'svc_authenticator' | 'svc_scheduler' | 'svc_relay' | 'svc_bulk_worker';
