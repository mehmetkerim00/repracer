...
export const STEP24_ROWS = [
  ...
  },
  {
    ...
    mutations: [
      ...
      m(replaceInFunction('tenant_data.omnibus_lowest_prior_price(uuid,uuid,timestamp with time zone)', 'AND h.accepted_at >= to_ts AND h.accepted_at < p_starts_at', 'AND false'),
