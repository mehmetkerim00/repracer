...
const VERIFY = 'migrations/0121_verify_schema_invariants_v32.sql';
...
/**
 * Шаг 36 [Р-156]: алерт в базе и его доставка владельцу. Каждая новая защита — своя строка при создании [Р-108],
 * и каждая ловится своей проверкой [Р-99].
 */
